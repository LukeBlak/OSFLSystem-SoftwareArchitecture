...
export const validateProject = [
  ...
  body('fecha_inicio')
    ...
    .isISO8601().withMessage('fecha_inicio debe ser una fecha v�lida (ISO 8601)'),

  body('fecha_fin')
    .notEmpty().withMessage('La fecha de fin es requerida')
    .isISO8601().withMessage('fecha_fin debe ser una fecha v�lida (ISO 8601)')
  ...
  body('descripcion')
    .optional()
    .trim()
    .isLength({ max: 500 }).withMessage('La descripci�n no puede superar 500 caracteres'),

  body('presupuesto_asignado')
    .optional()
    .isFloat({ min: 0 }).withMessage('El presupuesto asignado debe ser un n�mero mayor o igual a 0'),

  body('recomendacion_horas')
    .optional()
    .isFloat({ min: 0 }).withMessage('La recomendaci�n de horas debe ser un n�mero mayor o igual a 0'),
];
