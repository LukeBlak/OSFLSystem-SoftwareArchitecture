...
export const formatCommitteeForResponse = (committee) => {
  ...
  return {
    ...
    areaResponsabilidad: committee.areaResponsabilidad ?? committee.arearesponsabilidad ?? null,
    descripcion: committee.descripcion,
    estado: committee.estado,
    presupuestoAsignado: committee.presupuestoAsignado ?? committee.presupuestoasignado ?? 0,
    organizacionId: committee.organizacionId ?? committee.organizacionid ?? null,
    liderComiteId: committee.liderComiteId ?? committee.lidercomiteid ?? null,
    creadoPor: committee.creadoPor ?? committee.creado_por ?? null,
    modificadoPor: committee.modificadoPor ?? committee.modificado_por ?? null,
    fechaCreacion: committee.fechaCreacion ?? committee.fecha_creacion ?? null,
    fechaEdicion: committee.fechaEdicion ?? committee.fecha_edicion ?? null,
