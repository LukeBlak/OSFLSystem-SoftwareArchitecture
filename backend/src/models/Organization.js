...
export const formatOrganizationForResponse = (organization) => {
  ...
  return {
    ...
    saldoActual: organization.saldoActual ?? organization.saldoactual ?? 0,
    estado: organization.estado ?? null,
    fechaCreacion: organization.fechaCreacion ?? organization.fecha_creacion ?? organization.fechacreacion ?? null,
    fechaEdicion: organization.fechaEdicion ?? organization.fecha_edicion ?? null,
